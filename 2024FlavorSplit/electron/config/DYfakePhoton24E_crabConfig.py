...
base = "DY_FakePhoton_Run3_24_E_FullSim"
...
config.JobType.inputFiles  = [
    "voms_proxy.txt",
    "config/DYfakePhoton24E_FullSim.env",
    "config/DYfakePhoton24E_fragment.py",
    "ProduceDYfakePhoton24E.sh"
]
config.JobType.outputFiles = [
    "DYto2E-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__RunIII2024Summer24NanoAODv15-150X_mcRun3_2024_realistic_v2-v4__privateProduction__job.root"
]
