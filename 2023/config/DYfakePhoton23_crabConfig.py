...
config.JobType.inputFiles  = [
    "voms_proxy.txt",
    "config/DYfakePhoton23_FullSim.env",
    "config/DYfakePhoton23_fragment.py",
    "ProduceDYfakePhoton23.sh"
]
config.JobType.outputFiles = [
    "DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v14__privateProduction__job.root"
]
...
config.JobType.scriptArgs  = [
    "script=ProduceDYfakePhoton23.sh",
    "events=10000",
    "names=DYfakePhoton23_FullSim.env",

#--------------------------Edit Below--------------------------
    "stageout_dir=YOUR_DIR/2023"         # Your directory name inside htozg-dy-privatemc directory
]
