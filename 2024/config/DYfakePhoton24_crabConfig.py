...
base = "DY_FakePhoton_Run3_24_FullSim"
...
config.JobType.inputFiles  = [
    "voms_proxy.txt",
    "config/DYfakePhoton24_FullSim.env",
    "config/DYfakePhoton24_fragment.py",
    "ProduceDYfakePhoton24.sh"
]
config.JobType.outputFiles = [
    "DYto2L-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__RunIII2024Summer24NanoAODv15-150X_mcRun3_2024_realistic_v2-v1__privateProduction__job.root"
]
...
config.JobType.scriptArgs  = [
    "script=ProduceDYfakePhoton24.sh",
    "events=10000",
    "names=DYfakePhoton24_FullSim.env",
    "submission_tag={}".format(submission_tag),

#--------------------------Edit Below--------------------------
    "stageout_dir=YOUR_DIR/2024"  # Directory inside htozg-dy-privatemc
]
