...
#   GEN-RunIII2024Summer24wmLHEGS-00057 (electron)
...
# Require an opposite-sign electron/muon pair after hadronization. This keeps
# direct electron and muon events, plus tau events with leptonic tau decays.
