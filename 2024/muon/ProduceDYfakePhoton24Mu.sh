...
if [ ! -f "$3" ]; then
  ...
  echo '  Example'
  echo '    Fragment_filename="DYfakePhoton24Mu_fragment.py"'
  echo '    AOD_NAME="DYto2Mu-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__RunIII2024Summer24DRPremix-140X_mcRun3_2024_realistic_v26-v6__privateProduction"'
  echo '    MINIAOD_NAME="DYto2Mu-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__RunIII2024Summer24MiniAODv6-150X_mcRun3_2024_realistic_v2-v6__privateProduction"'
  echo '    NANOAOD_NAME="DYto2Mu-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__RunIII2024Summer24NanoAODv15-150X_mcRun3_2024_realistic_v2-v6__privateProduction"'
  echo '    BASE_TAG="DYto2Mu-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer24"'
  exit
fi
...
echo "--------------------------------LHE,GEN,SIM-------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-RunIII2024Summer24wmLHEGS-00055
...
echo "---------------------------------DIGIPREMIX------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-RunIII2024Summer24DRPremix-00072
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc12
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
...
echo "----------------------------------MiniAODv6-------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-RunIII2024Summer24MiniAODv6-00006
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc12
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
...
echo "-----------------------------------NanoAODv15------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-RunIII2024Summer24NanoAODv15-00006
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc12
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
if [ -r CMSSW_15_0_4/src ] ; then
...
rm -rf CMSSW_14_0_19 CMSSW_14_0_21 CMSSW_15_0_4
