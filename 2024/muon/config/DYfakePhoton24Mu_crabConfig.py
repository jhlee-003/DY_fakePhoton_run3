...
base = "DY_FakePhoton_Run3_24_Mu_FullSim"
...
config.JobType.inputFiles  = [
    "voms_proxy.txt",
    "config/DYfakePhoton24Mu_FullSim.env",
    "config/DYfakePhoton24Mu_fragment.py",
    "ProduceDYfakePhoton24Mu.sh"
]
config.JobType.outputFiles = [
    "DYto2Mu-2Jets_Bin-MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__RunIII2024Summer24NanoAODv15-150X_mcRun3_2024_realistic_v2-v6__privateProduction__job.root"
]
...
config.JobType.scriptArgs  = [
    "script=ProduceDYfakePhoton24Mu.sh",
    "events=10000",
    "names=DYfakePhoton24Mu_FullSim.env",

#--------------------------Edit Below--------------------------
    "stageout_dir=YOUR_DIR/2024/muon"  # Directory inside htozg-dy-privatemc
]
