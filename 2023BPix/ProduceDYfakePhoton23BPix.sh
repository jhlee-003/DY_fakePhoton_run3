...
if [ ! -f "$3" ]; then
  ...
  echo '  Example'
  echo '    Fragment_filename="DYfakePhoton23BPix_fragment.py"'
  echo '    AOD_NAME="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer23BPixDRPremix-130X_mcRun3_2023_realistic_postBPix_v2__privateProduction"'
  echo '    MINIAOD_NAME="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2__privateProduction"'
  echo '    NANOAOD_NAME="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer23BPixNanoAODv12-130X_mcRun3_2023_realistic_postBPix_v2__privateProduction"'
  echo '    BASE_TAG="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer23BPix"'
  exit
fi
...
echo "--------------------------------LHE,GEN,SIM-------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer23BPixwmLHEGS-00325
...
echo "---------------------------------DIGIPREMIX------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer23BPixDRPremix-00246
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc11
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
if [ -r CMSSW_13_0_14/src ] ; then
...
echo "----------------------------------MiniAODv4-------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer23BPixMiniAODv4-00246
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc11
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
if [ -r CMSSW_13_0_14/src ] ; then
...
echo "-----------------------------------NanoAODv12------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer23BPixNanoAODv12-00246
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc11
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
if [ -r CMSSW_13_0_14/src ] ; then
