...
if [ ! -f "$3" ]; then
  ...
  echo '  Example'
  echo '    Fragment_filename="DYfakePhoton22_fragment.py"'
  echo '    AOD_NAME="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer21PrePremix-Summer22_124X_mcRun3_2022_realistic_v11-v2__privateProduction"'
  echo '    MINIAOD_NAME="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer22_MiniAODv4-130X_mcRun3_2022_realistic_v5__privateProduction"'
  echo '    NANOAOD_NAME="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer22_NanoAODv12-130X_mcRun3_2022_realistic_v5__privateProduction"'
  echo '    BASE_TAG="DYto2L-2Jets_MLL-50_TuneCP5_13p6TeV_amcatnloFXFX-pythia8__Run3Summer22"'
  exit
fi
...
echo "--------------------------------LHE,GEN,SIM-------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer22wmLHEGS-00471
...
echo "---------------------------------DIGIPREMIX------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer22DRPremix-00321
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc10
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
if [ -r CMSSW_12_4_11_patch3/src ] ; then
...
echo "----------------------------------MiniAODv4-------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer22MiniAODv4-00310
echo "Setting up CMSSW"
...
echo "-----------------------------------NanoAODv12------------------------------------"
# https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_setup/GEN-Run3Summer22NanoAODv12-00310
echo "Setting up CMSSW"
export SCRAM_ARCH=el8_amd64_gcc11
[[ $- == *u* ]] && U_WAS_ON=1 || U_WAS_ON=0; set +u; source /cvmfs/cms.cern.ch/cmsset_default.sh; ((U_WAS_ON)) && set -u
if [ -r CMSSW_13_0_13/src ] ; then
